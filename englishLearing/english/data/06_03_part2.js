...
wordJson['06_03_part2']  = [

    {
        ...
        english: 'underpin',
        symbols: '[ˌʌndəˈpɪn]',
        chinese: '向下钉砖（打基础）；加强基础；加强墙或屋子的基础；'
    },{
        english: 'steam',
        symbols: '[sti:m]',
        chinese: '蒸汽;冒蒸汽; '
        ...
        english: 'coordinate',
        symbols: '[kəʊ ɔ:dɪneɪt]',
        chinese: '协调; 协同; 使协调，使调和; '
    },{
        english: 'vie',
        symbols: '[vaɪ]',
        chinese: '竞争,使竞争; 作较量;'
        ...
        english: 'ambition',
        symbols: '[æmˈbɪʃn]',
        chinese: '抱负; 追求; 有…野心; 渴望得到的东西; 追求的目标; '
    },{
        english: 'capability',
        symbols: '[ˌkeɪpəˈbɪləti]',
        chinese: '才能，能力;'
    },{
        english: 'Afghanistan',
        symbols: '[æf ɡænɪstæn]',
...

    {
        ...
        english: 'irreversibly',
        symbols: '[ˌɪrɪ vɜ:səblɪ]',
        chinese: '不可更改地，不可挽回地，不可反转地;'
    },{
        english: 'standing',
        symbols: '[ˈstændɪŋ]',
        chinese: '身份，地位; '
        ...
        english: 'bankrupt',
        symbols: '[ˈbæŋkrʌpt]',
        chinese: '破产的，倒闭的; 枯竭的;垮了的;使破产，使枯竭，使极端贫困;'
    },{
        english: 'insolvency',
        symbols: '[ɪn sɒlvənsɪ]',
        chinese: '破产; 无力偿付债务; 倒闭; 无偿债能力;'
    },{
        english: 'avert',
        symbols: '[əˈvɜ:t]',
        chinese: '防止，避免;'
        ...
        english: 'instalment',
        symbols: '[ɪnˈstɔ:lmənt]',
        chinese: '分期付款; '
    },{
        english: 'complicate',
        symbols: '[ˈkɒmplɪkeɪt]',
        chinese: '使复杂化;复杂的; 麻烦的;'
    },{
        english: 'communism',
        symbols: '[ˈkɒmjunɪzəm]',
        chinese: '共产主义; 共产主义制度;'
        ...
        english: 'reclassify',
        symbols: '[ˌri:ˈklæsɪfaɪ]',
        chinese: '将…再次（重新）分类;'
    },{
        english: 'scatter',
        symbols: '[ˈskætə(r)]',
        chinese: '（使） 散开，（使）分散，驱散;撒布'
    },{
